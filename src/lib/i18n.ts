...
const zh: Dict = {
  ...
  'habit.section': '每日',
  'habit.placeholder': '添加一件每天要做的事…',
  'habit.none': '还没有每日项。',
  'habit.edit': '编辑每日项',
  'habit.title': '内容',
  'habit.deleteAsk': '确定删除“{name}”？勾过的每一天都会一起没掉。',
  'habit.new': '新建每日项',
  'habit.note': '备注',
...
const fr: Dict = {
  ...
  'habit.section': 'Quotidien',
  'habit.placeholder': 'Ajouter une habitude quotidienne…',

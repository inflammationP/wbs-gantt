    ...
    <aside className="w-[320px] shrink-0 border-l border-border bg-panel flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 px-4 py-3 border-b border-border">
        <div className="flex items-center justify-between mb-2">
          <span className="text-[10px] uppercase tracking-wider text-dim">Project</span>
          <button onClick={() => setSelectedProject(null)} className="text-dim hover:text-fg"><X size={16} /></button>
        </div>
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-panel2 border border-border rounded-[3px] px-2 py-2 text-center">
            ...
            <div className="text-[9px] uppercase tracking-wider text-dim">Tasks</div>
          </div>
          <div className="bg-panel2 border border-border rounded-[3px] px-2 py-2 text-center">
            <div className="text-[15px] font-mono text-fg">{stats.done}</div>
            <div className="text-[9px] uppercase tracking-wider text-dim">Done</div>
          </div>
          <div className="bg-panel2 border border-border rounded-[3px] px-2 py-2 text-center">
            <div className="text-[15px] font-mono text-fg">{stats.leaves - stats.done}</div>
            <div className="text-[9px] uppercase tracking-wider text-dim">Open</div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-1.5 text-[12px] text-muted leading-relaxed whitespace-pre-wrap">{project.description || 'No description.'}</div>
        </div>
      </div>
